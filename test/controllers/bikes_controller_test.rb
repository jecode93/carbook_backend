...
class BikesControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create bike' do
    assert_difference('Bike.count') do
      post bikes_url,
           params: { bike: { deposit: @bike.deposit, description: @bike.description, duration: @bike.duration,
                             finance_fee: @bike.finance_fee, name: @bike.name, option_to_purchase_fee: @bike.option_to_purchase_fee, total_amount_payable: @bike.total_amount_payable, user_id: @bike.user_id } }
    end
